...
5. **MCP server smoke start** — run `python -m pywry.mcp serve --transport stdio` in the background with a 3‑second timeout. Confirm it starts without crashing (a clean stdio server waits on input). Kill it after.
